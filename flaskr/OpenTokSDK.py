...
class OpenTokSDK(object):
    ...
    def generate_token(self, session_id=None, role=None, expire_time=None, connection_data=None, **kwargs):
        ...
        role: One of the constants defined in RoleConstants. Default is publisher, 
        look in the documentation to learn more about roles.
        expire_time: Integer timestamp. You can override the default token expire time of 24h 
        by choosing an explicit expire time. Can be up to 7d after create_time.
        """
